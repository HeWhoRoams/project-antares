...
echo ===============================================================================
echo Project Antares - Improved CI/CD Pipeline with GDScript Toolkit Integration
echo ===============================================================================
...
echo [INFO] Starting improved CI/CD pipeline with GDScript Toolkit integration...
